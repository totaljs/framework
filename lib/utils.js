...
exports.validation = function (obj, without, cb, resource) {
	var arr = [];
	...
	for (var i in obj) {
		...
		if (type === 'object') {
			var tmp = exports.validation(value, without, cb, resource);
			if (tmp.length > 0) {
...
Object.prototype.validation = function (without, cb, resource) {
	return exports.validation(this, without, cb, resource);
};
